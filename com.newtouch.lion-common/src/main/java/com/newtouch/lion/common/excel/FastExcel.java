...
public final class FastExcel{
     ...
     */
    public FastExcel(String excelFilePath) throws IOException {
        this.startRow = 0;
     ...
     * @throws IOException            IO流异常
     */
    public FastExcel(InputStream inputStream) throws IOException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
        this.excelFilePath = "";
     ...
     * @throws IOException            IO流异常
     */
    public FastExcel(InputStream inputStream, String outFilePath) throws IOException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
    ...
    public <T> List<T> parse(Class<T> clazz) {
        ...
        try {
            ...
            if (null != sheet) {
                ...
                HSSFRow row = sheet.getRow(this.startRow);
    ...
    public <T> boolean createExcel(List<T> list) {
        if (StringUtils.isEmpty(this.excelFilePath))
